...
const Formulario = ({cliente,cargando}) => {
    ...
    <div className='bg-white mt-10 px-5 py-10 rounded-md shadow-md md:w-3/4 mx-auto'>
        <h1 className='text-grey-600 font-bold text-xl uppercase text-center'>{cliente?.nombre ?'Editar Cliente' : 'Agregar Hotel'}</h1>
        <Formik
            initialValues={{
        ...
        >
            ...
            >
                ...
                <input 
                type="submit"
                value={cliente?.nombre ?'Editar Cliente' : 'Agregar Hotel'}
